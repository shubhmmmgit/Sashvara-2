  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Browse our curated collection for women." />
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="pt-8 pb-6">
        ...
        <div>
            <h1 className="pageHeading text-3xl font-bold text-center text-[#001f3f]">Women</h1>
            <p className="pageTag text-sm text-center  text-[#001f3f] mt-1">
