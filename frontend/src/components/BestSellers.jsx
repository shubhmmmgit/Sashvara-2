...
export default function BestSellers() {
  ...
  return (
    ...
    <Helmet> 
       ...
       <meta name="description" content="Our most loved pieces — customer favourites and top-rated styles." />
      ...
      <div className="pt-8 pb-6">
        ...
        <nav className="text-sm mb-2" aria-label="Breadcrumb">
          <ol className="list-reset flex text-gray-600">
           ...
           <div>
            <h1 className="pageHeading text-3xl font-bold text-center text-[#001f3f]">Best Sellers</h1>
