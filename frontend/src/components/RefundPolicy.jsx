    ...
    <div className="min-h-screen bg-gray-50 py-12 flex items-center justify-center px-4  w-[80%] ml-[10%] ">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>One time size exchange allowed with a small charge of ₹100, subject to availability.  <strong>NOTE : It is for Reverse pickup fee</strong> </li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Partial COD advance 25% amount is non - refundable if you cancel the order after 12 hours of placing it or due to any reason not accept the parcel at time of delivery.</li>
