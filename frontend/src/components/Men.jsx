...
export default function Men() {
  ...
  return (
    <>
        ...
        <title>Men Collection – Sashvara</title>
        <meta name="description" content="Discover our men’s collection — handpicked styles." />
            ...
            <li> 
                <Link to="/men" className="hover:underline text-[#001f3f] visited:text-[#001f3f] ">
                  /men
                     ...
                     <div>
            <h1 className="pageHeading text-3xl  text-center text-[#001f3f]">Men</h1>
            <p className="pageTag text-sm  text-center text-[#001f3f]">
