...
export default function ProductList({ 
 ...
 />
            ...
            <div className="p-3">
              ...
              <div className="productName text-sm font-semibold text-[#001f3f] text-center whitespace-normal break-words no-underline">{p.name}</div>
              <div className="prizeTag mt-1 flex items-baseline gap-[2%] justify-center space-y-[5%] ">
              ...
              <div className="sizeAvail mt-2 text-xs text-[#001f3f] text-center visited:text-[#001f3f] ">
