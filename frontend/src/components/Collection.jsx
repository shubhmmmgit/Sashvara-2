  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div id="moreCollection" className="grid grid-cols-3">
        <Link to="/collections/aafat_ki_adda" className="text-[#001f3f] underline"><img src={imageUrl("https://res.cloudinary.com/dgnevjqr6/image/upload/aafat_ki_adaa_dsotkq.png", { w: 800, q: 75, dpr: "auto"})}className="w-[80%]"/></Link>
         <Link to="/collections/desi_drama" className="text-[#001f3f] underline"><img src={imageUrl("https://res.cloudinary.com/dgnevjqr6/image/upload/v1758827892/template_2_2_wjubon.png", { w: 800, q: 75, dpr: "auto"})} className="w-[80%]"/></Link>
         <Link to="/collections/patakha" className="text-[#001f3f] underline" ><img src={imageUrl("https://res.cloudinary.com/dgnevjqr6/image/upload/v1758827882/template_1_2_3_rxtzmj.png", { w: 800, q: 75, dpr: "auto"})} className="w-[80%] "/></Link>
      </div>
