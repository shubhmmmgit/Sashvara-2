  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 ">
      <div className="max-w-6xl mx-auto px-4">
        <h1 className="text-3xl text-center font-bold text-[#001f3f] mb-8 border-b-1 border-[#808080] ">Checkout</h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-2  ">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4  ">
                  ...
                  {/* Shipping Method */}
                  <div>
                    <h3 className="text-lg font-medium text-[#001f3f] mb-2">Shipping method</h3>
                    <input
                      type="text"
                      placeholder="Enter your shipping address to view available shipping methods"
                      className="w-[60%] border border-gray-300  rounded-md focus:outline-none focus:ring-2 focus:ring-[#27ADF5] focus:border-transparent" style={{borderRadius:"5px",  minHeight:"35px"}}
                      disabled
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                     {/*  <label className="flex items-center p-3 border border-gray-300 rounded-md hover:bg-gray-50">
                      ...
                      <label className="flex items-center w-[70%] p-3 border text-[#808080] border-gray-300 rounded-md hover:bg-gray-50" style={{borderRadius:"5px",  minHeight:"35px"}}> 
                        <input
                          type="radio"
                          name="paymentMethod"
                          value="upi"
                      ...
                      <label className="flex items-center w-[70%] p-3 text-[#808080] border border-gray-300 rounded-md hover:bg-gray-50" style={{borderRadius:"5px",  minHeight:"35px"}}> 
                        <input
                          type="radio"
                          name="paymentMethod"
                          value="cod"
          ...
          <div className="lg:sticky lg:top-8  ">
            <div className="bg-[#EDEDED] rounded-lg shadow-sm p-6 mr-[25%] h-[100%] ">
              <h2 className="text-xl font-semibold text-[#001f3f] text-center ">Order Summary</h2>
              ...
              <div className="  pt-4">
                ...
                <div className="flex justify-start gap-[26%] ml-[2%]">
              ...
              <PrimaryButton
                ...
                className="w-[60%] mt-6 py-3 text-lg ml-[2%]"
              >
                Complete Order
              </PrimaryButton>
            </div>
